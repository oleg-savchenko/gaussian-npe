...
#SBATCH --time=4:00:00
#SBATCH --job-name=net_WienerNet
#SBATCH --output=paper_test_runs/logs/net_WienerNet_%j.out
#SBATCH --error=paper_test_runs/logs/net_WienerNet_%j.err
